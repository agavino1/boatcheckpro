...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-base-200 flex items-center justify-center px-4 pt-20">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-base-content">{t.auth.login.title}</h1>
          <p className="text-base-content/60 mt-2">{t.auth.login.subtitle}</p>
        </div>
          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="form-control">
                <label className="label"><span className="label-text">{t.auth.login.email}</span></label>
                <input
                  type="email"
                  value={email}
              ...
              <div className="form-control">
                <label className="label"><span className="label-text">{t.auth.login.password}</span></label>
