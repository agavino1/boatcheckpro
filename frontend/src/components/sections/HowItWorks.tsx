  ...
  const steps = [
    {
      ...
      description:
        'Select your boat type, location, and preferred inspection date. Our availability calendar shows real-time openings.',
    },
    {
      icon: Clipboard,
      number: 2,
      ...
      description:
        'A certified marine technician visits your boat and conducts a comprehensive inspection using latest technology.',
    },
    {
      icon: CheckCircle,
      number: 3,
      ...
      description:
        'Receive a detailed PDF report within 24 hours with photos, findings, and recommendations.',
    },
    {
      icon: FileCheck,
      number: 4,
      ...
      description:
        'Your inspection is official and can be used for insurance, sales, financing, or personal peace of mind.',
    },
  ]
    ...
    <section id="how-it-works" className="py-20 bg-white">
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle">Simple, transparent, and hassle-free boat inspections</p>
        </div>
